...
export async function getServerSideProps(context: any) {
  ...
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/question/tag/${id}`);
    const questions = await response.json();
    const tagResponse = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/question/tags/`);
