...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    ...
    const questionFetch = await axios.get(`${process.env.BACKEND_URL || "http://localhost:8000/"}question/${id}/`);
    ...
    const allQuestionsFetch = await axios.get(`${process.env.BACKEND_URL || "http://localhost:8000/"}question/add`);
